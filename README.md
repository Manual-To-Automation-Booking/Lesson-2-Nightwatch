...
There is a Javascript and Typescript version of the test files.
...
```sh
git clone https://github.com/Manual-To-Automation-Booking/Lesson-2-Nightwatch.git
```

Move into the directory:

```sh
cd Lesson-2-Nightwatch
```
